...
export const metadata: Metadata = {
  title: "CoffeeHouse | Specialty Coffee & Artisan Brews",
  description: "Experience premium, ethically-sourced specialty coffee. Fresh roasted daily. Perfect for coffee lovers seeking quality and sustainability.",
  keywords: "specialty coffee, artisan coffee, espresso, latte, cold brew, fair trade coffee, coffee shop",
  metadataBase: new URL("https://coffeehouse.com"),
  alternates: {
    canonical: "https://coffeehouse.com"
  },
  openGraph: {
    title: "CoffeeHouse | Premium Specialty Coffee",
    description: "Discover exceptional coffee crafted from the finest beans. Visit our coffee shop for authentic specialty brews.",
    url: "https://coffeehouse.com",
    siteName: "CoffeeHouse",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765899254134-9kbxyysg.jpg",
        alt: "CoffeeHouse specialty coffee experience"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "CoffeeHouse | Specialty Coffee",
    description: "Premium ethically-sourced coffee roasted fresh daily",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765899254134-9kbxyysg.jpg"]
  },
  robots: {
    index: true,
    follow: true
